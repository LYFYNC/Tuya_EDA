...
// UART
#define WM_UART2_RX_PIN  37          // PB19 : UART2_RX  (W601)
#define WM_UART2_TX_PIN  37          // PB20 : UART2_TX  (W601)   

#define WM_UART1_RX_PIN  48         // PB11 : UART1_RX  (W600)
#define WM_UART1_TX_PIN  49         // PB12 : UART1_TX  (W600)
...
// i2c
#define SOFT_I2C1_SCL_PIN 66         // PA0 : I2C1_SCL     
#define SOFT_I2C1_SDA_PIN 67         // PA1 : I2C1_SDA   
#define SOFT_I2C2_SCL_PIN 33         // PA2 : I2C2_SCL     
#define SOFT_I2C2_SDA_PIN 35         // PA1 : I2C2_SDA   
...
// BEEP && LED && KEY
#define PIN_BEEP      24        // PB15:  BEEP         --> BEEP
#define PIN_LED_R     3        // PE7 :  LED_R        --> LED
#define PIN_LED_G     31        // PE8 :  LED_B        --> LED
#define PIN_LED_B     32        // PE9 :  LED_G        --> LED

#define PIN_TOUCH_R   43
#define PIN_TOUCH_L   44

#define PIN_USB_CHECK 1
...
#define PIN_RECEPTION 36        // PA10:  RECEPTION    --> INFRARED RECEPTION
...
#define PIN_LCD_CS    4        // PB0 :  LCD_CS       --> LCD
