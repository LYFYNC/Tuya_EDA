...
extern void lcd_color_fill(rt_uint16_t x_start, rt_uint16_t y_start, rt_uint16_t x_end, rt_uint16_t y_end, rt_uint16_t *color);
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    lcd_color_fill(area->x1, area->y1, area->x2, area->y2, (rt_uint16_t *)color_p);
